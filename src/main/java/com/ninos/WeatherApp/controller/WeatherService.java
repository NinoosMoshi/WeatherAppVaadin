package com.ninos.WeatherApp.controller;
...
public class WeatherService {
    ...
    public JSONObject getWeather() throws JSONException {
        ...
        Request request = new Request.Builder()
                .url("http://api.openweathermap.org/data/2.5/weather?q="+getCityName()+"&units="+getUnit()+"&APPID=15603df468c6cc1d99215e38b987bc4f")
                .build();
        try {
